...
def main():
    ...
    phi2 = -45      # Rotation angle of part 2 in degrees
    phi3 = -45      # Rotation angle of part 3 in degrees
    phi4 = 0     # Rotation angle of the end-effector in degrees

    for phi2 in range(-45, 45, 1):
        ...
        plotter.add(Frame4)
        plotter.add(axes)
        plotter.show(viewup="z", interactive = False)
        plotter.close()
